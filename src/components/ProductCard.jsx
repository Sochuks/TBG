...
return(
<a href="#" className="group relative block overflow-hidden rounded shadow-xs border border-gray-100">
  <button
  ...
  <div className="relative border border-gray-100 bg-white p-6">
    ...
    <p className="mt-1.5 text-sm text-gray-700">{product.actual_price}</p>
